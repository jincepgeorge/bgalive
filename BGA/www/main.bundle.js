...
var BoardComponent = /** @class */ (function () {
    function BoardComponent(db, spinnerService) {
        ...
        this.boardMembers = db.collection('/boardmembers', function (ref) { return ref.orderBy('priority'); }).valueChanges();
...
var ContentManagerComponent = /** @class */ (function () {
    function ContentManagerComponent(db, afStorage) {
        ...
        this.sermons = this.db.collection('sermons');
    ...
    ContentManagerComponent.prototype.uploadImageAndSaveData = function () {
        var _this = this;
        this.uploadImages();
